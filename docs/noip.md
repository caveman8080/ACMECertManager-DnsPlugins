...
This is the 2024 No-IP DNS API, not the older Dynupdate `/nic/update` endpoint (A/AAAA only).

Credentials:

- `apiKey` — No-IP API key from the [API Key management page](https://www.noip.com/) (required)
